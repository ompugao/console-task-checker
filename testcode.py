...
class Test_TaskChecker(unittest.TestCase):
	...
	def test_add_function(self):
		os.system("python task.py add 2012/03/20 確定申告")
		os.system("python task.py add 2012/03/30 テストテスト")
		os.system("python task.py add 2013/01/01 元旦")
		os.system("python task.py add 2012/04/15 テスト")
